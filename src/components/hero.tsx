...
export function HeroSection() {
  return (
    <section
      id="home"
      className="relative overflow-hidden pb-[40px] pt-[140px] text-[color:var(--color-foreground)] sm:pb-[60px] lg:pb-[80px]"
    >
      ...
      <div className="layout-container grid items-center gap-12 lg:grid-cols-[1.05fr_0.95fr] lg:gap-16">
        <motion.div
          className="space-y-8"
          initial="hidden"
          whileInView="visible"
        ...
        >
          ...
          <motion.h1
            className="text-[32px] font-bold leading-[1.25] text-[color:var(--color-foreground)] sm:text-[40px] sm:leading-[1.2] lg:text-[48px] lg:leading-[1.15]"
            variants={fadeFast}
            style={{ willChange: "transform" }}
          >
          ...
          >
            <a
              href="#courses"
              className="inline-flex touch-target items-center justify-center rounded-full bg-gradient-to-r from-[#2810b2] via-[#49b3e1] to-[#84efc7] px-7 py-3 text-sm font-semibold text-white shadow-[0_24px_45px_rgba(40,16,178,0.2)] transition-transform duration-300 ease-out hover:translate-y-[-4px] hover:scale-[1.03] active:scale-95 sm:px-8"
            >
              Get Started
            </a>
            <a
              href="#signin"
              className="inline-flex touch-target items-center justify-center gap-2 rounded-full border border-[rgba(40,16,178,0.25)] px-7 py-3 text-sm font-semibold text-[color:var(--color-primary)] transition-transform duration-300 ease-out hover:translate-y-[-4px] hover:scale-[1.03] active:scale-95 sm:px-8"
            >
        ...
        >
          <div className="relative w-full max-w-xl">
            ...
            <div className="absolute -right-12 top-10 hidden w-40 rounded-3xl border border-white/60 bg-white/90 p-5 text-sm shadow-[0_20px_45px_rgba(40,16,178,0.18)] lg:block">
            ...
            <div className="absolute -left-12 bottom-10 hidden w-44 rounded-3xl border border-white/60 bg-white/90 p-5 text-sm shadow-[0_20px_45px_rgba(40,16,178,0.18)] lg:block">
              <p className="text-xs font-semibold uppercase tracking-wide text-[color:var(--color-muted)]">
                Empowered Students
              </p>
              <p className="mt-1 text-2xl font-bold text-[color:var(--color-primary)]">
            ...
            {[
              {
                ...
                value: "300+",
                description: "Expert mentors across MENA & Europe.",
              },
              {
                title: "Empowered Students",
                value: "50K+",
                description: "Learners thriving across Algeria & beyond.",
              },
            ].map((stat) => (
              <div
                key={stat.title}
                className="rounded-3xl border border-white/70 bg-white/85 p-5 text-sm shadow-[0_18px_35px_rgba(40,16,178,0.12)]"
              >
                <p className="text-xs font-semibold uppercase tracking-wide text-[color:var(--color-muted)]">
                  {stat.title}
                </p>
